...
router.get('/', authMiddleware, async (req, res) => {
  try {
    const { rows } = await db.query(`
      SELECT
        g.id, g.name, g.photo_url, g.created_at, g.daily_goal_value, g.weekly_goal_value, g.goal_points, g.daily_goal_meta2, g.daily_goal_meta3, g.daily_goal_meta4,
      ...
      WHERE g.active = true
      GROUP BY g.id, g.name, g.photo_url, g.created_at, g.daily_goal_value, g.weekly_goal_value, g.goal_points, g.daily_goal_meta2, g.daily_goal_meta3, g.daily_goal_meta4,
